...
import { Award, Coins, Info, Shield, TrendingUp, Zap } from "lucide-react";
...
const RANK_AVATAR_MAP: Record<string, string> = {
  ...
  "Shadow Monarch":
    "/assets/generated/rank-avatar-shadow-monarch.dim_128x128.png",
};
  ...
  if (isShadowMonarch) {
    return (
      <span
        ...
        style={{
          background:
            "linear-gradient(135deg, rgba(139,92,246,0.25) 0%, rgba(234,179,8,0.25) 100%)",
          border: "1px solid rgba(234,179,8,0.6)",
          color: "#fbbf24",
          textShadow: "0 0 8px rgba(251,191,36,0.8)",
          boxShadow:
            "0 0 12px rgba(139,92,246,0.4), inset 0 0 8px rgba(234,179,8,0.1)",
        }}
      >
        <Shield
          className="h-3 w-3"
    ...
    <div className="space-y-6">
      ...
      >
        ...
        <div className="relative space-y-4 p-8">
          <div>
            <h2 className="mb-1 text-3xl font-semibold text-white/95">
              {COPY.dashboard.welcomeBack}, {profile.nickname}
            </h2>
      ...
      >
        <CardHeader>
          ...
          <p className="text-sm text-white/60">
            {COPY.customTasks.createTaskDescription}
          </p>
        </CardHeader>
        <CardContent>
          <CustomTaskForm />
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-5">
        ...
        <Card
          className="border-accent/40 transition-colors hover:border-accent/60"
          style={{
            background: "rgba(0, 0, 0, 0.8)",
            backdropFilter: "blur(12px)",
          }}
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-white/75">
              {Number(profile.xpToNextLevel - profile.xp)}{" "}
              {COPY.dashboard.toNextLevel}
            </p>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-white/75">
              {COPY.dashboard.currencyBalance}
            </p>
          </CardContent>
        </Card>
        ...
        >
          ...
          <CardContent>
            ...
            <p className="text-xs text-white/75">
              {COPY.dashboard.availableToAllocate}
            </p>
          </CardContent>
        </Card>
      </div>
        ...
        <CardContent className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            <span className="text-white/75">
              {COPY.dashboard.level} {Number(profile.level)}
            </span>
      ...
      >
        <CardHeader>
          <CardTitle className="text-white/95">
            {COPY.dashboard.progressionSummary}
          </CardTitle>
        </CardHeader>
        <CardContent>
