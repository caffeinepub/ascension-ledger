...
export function RankInfoDialog({
  ...
  const currentTier =
    RANK_TIERS.find((t) => t.rank === currentRankInfo.rank) ??
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            borderColor: currentRankInfo.isShadowMonarch
              ? "rgba(234,179,8,0.6)"
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1 flex items-center justify-between">
              <span
                ...
                style={{
                  color: currentRankInfo.isShadowMonarch
                    ? "#fbbf24"
                    : currentTier.text,
                  background: currentRankInfo.isShadowMonarch
                    ? "linear-gradient(90deg, #c084fc, #fbbf24)"
                    : undefined,
                  WebkitBackgroundClip: currentRankInfo.isShadowMonarch
                    ? "text"
                    : undefined,
                  WebkitTextFillColor: currentRankInfo.isShadowMonarch
                    ? "transparent"
                    : undefined,
                  backgroundClip: currentRankInfo.isShadowMonarch
                    ? "text"
                    : undefined,
                }}
              >
            ...
            return (
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    isCurrent && tier.isShadowMonarch
              ...
              >
                <div className="flex items-center gap-2.5">
                  ...
                  <span
                    ...
                    style={{
                      color: isCurrent ? tier.text : "rgba(255,255,255,0.55)",
                    }}
                  >
                    {tier.rank}
                  </span>
                ...
                <span
                  ...
                  style={{
                    color: isCurrent ? tier.text : "rgba(255,255,255,0.35)",
                  }}
                >
                  {levelRange}
                </span>
