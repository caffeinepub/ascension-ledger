      ...
      >
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-3">
            <img
              src="/assets/generated/cryonex-logo.dim_512x512.png"
              alt="CRYONEX"
      ...
      <div className="flex flex-1 overflow-hidden relative">
        ...
        {isNavExpanded && (
          <div
            ...
            onKeyUp={(e) => {
              if (e.key === "Enter" || e.key === " ") setIsNavExpanded(false);
            }}
            role="button"
            tabIndex={0}
          />
        ...
        >
          <div
            className={`space-y-1 transition-opacity duration-300 ${isNavExpanded ? "opacity-100" : "opacity-0 md:opacity-100"}`}
          >
            {navItems.map((item) => (
              <button
                type="button"
