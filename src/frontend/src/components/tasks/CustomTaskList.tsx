    ...
    >
      ...
      <CardContent className="space-y-6">
                    ...
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-medium text-white/95 mb-2">
                            {task.title}
                          </h3>
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <div className="flex items-center gap-1.5">
                              ...
                              >
                                {Number(task.attributePoints)}{" "}
                                {COPY.customTasks.attributePoints}
                              </Badge>
                            </div>
                          </div>
                        </div>
                      ...
                      >
                        {toggleCompletion.isPending
                          ? COPY.customTasks.completing
                          : COPY.customTasks.complete}
                      </Button>
                    </div>
                  </CardContent>
                </Card>
        ...
        {completedTasks.length > 0 && (
          <div className="space-y-3">
            <h3 className="text-sm font-semibold text-white/90">
              {COPY.customTasks.completedTasks}
            </h3>
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                  ...
                  <CardContent className="p-4">
                    <div className="space-y-3">
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          <h3 className="font-medium text-white/75 line-through mb-2">
                            {task.title}
                          </h3>
                          <div className="flex items-center gap-2 flex-wrap">
                            <div className="flex items-center gap-1.5">
                      ...
                      >
                        {toggleCompletion.isPending
                          ? COPY.customTasks.unmarking
                          : COPY.customTasks.markIncomplete}
                      </Button>
                    </div>
                  </CardContent>
                </Card>
